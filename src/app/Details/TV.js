  ...
  const getTV = async () => {
    try {
      const res = await API.get(
        `/tv/${params.id}?api_key=d0ff6f9cb6c33dcc6bc0c0a6381f2884`
      );
      const vid = await API.get(
        `/tv/${params.id}/videos?api_key=d0ff6f9cb6c33dcc6bc0c0a6381f2884`
      );
      const rec = await API.get(
        `/tv/${params.id}/recommendations?api_key=d0ff6f9cb6c33dcc6bc0c0a6381f2884`
      );
      const sim = await API.get(
        `/tv/${params.id}/similar?api_key=d0ff6f9cb6c33dcc6bc0c0a6381f2884`
      );
      const rev = await API.get(
        `/tv/${params.id}/reviews?api_key=d0ff6f9cb6c33dcc6bc0c0a6381f2884`
      );
        ...
        <Layout>
          ...
          <Box marginTop="300px" h="100vh">
            <Container maxW="container.xl">
              ...
              <SlideTvCard category={recommend} />
            </Container>
          </Box>
          <Box h="100vh">
            <Container maxW="container.xl">
